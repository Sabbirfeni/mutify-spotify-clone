...
function SongCard({ isPlaying, activeSong, countrySong, music, i, data }) {
  ...
  return (
    <div className='flex flex-col w-full p-4 bg-slate-800 backdrop-blur-sm animate-slideup duration-1000 rounded-lg cursor-pointer'>
      ...
      <div className='mt-4 flex flex-col'>
        ...
        <p className='text-sm truncate text-black-100 mt-1 text-white'>
